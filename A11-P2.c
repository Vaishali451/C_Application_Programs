// Accept N mumber from user and Accept one another number and check whether that number conatain in that N number or not return index of first occurance
#include<stdio.h>   // IO
